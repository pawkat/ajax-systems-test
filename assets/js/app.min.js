...
function aload(nodes) {
  ...
  [].forEach.call(nodes, function (node) {
    if (node.tagName === 'IMG' || node.tagName === 'IFRAME' || node.classList.contains('aload-bg')) {
      ...
      if (offset && Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getScrolledBottomCorner"])() >= offset || loadAlways) {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var scriptsToLoad = [{
    ...
    el: document.querySelector('.js-cm-form'),
    loadImmediatelyIfVisible: false
  }, {
    src: 'https://embed.typeform.com/embed.js',
    el: document.querySelector('.typeform-widget'),
    loadImmediatelyIfVisible: false
  }, {
    src: '/assets/js/components/field-label-inside.min.js' + verEnding,
    el: document.querySelector('.elementor-field-label-inside.js-field-label-inside input')
  }, {
    src: '/assets/js/components/select.min.js' + verEnding,
    el: document.querySelector('select.js-select, select.gfield_select'),
    dependencies: [{
      src: '/assets/js/jquery.selectric.min.js'
    }]
  }, {
    src: '/assets/js/components/get-views.min.js' + verEnding,
    el: document.querySelector('.js-post-views'),
    loadImmediatelyIfVisible: false
  }, {
    src: '/assets/js/components/fixed-block.min.js' + verEnding,
    el: document.querySelector('.fixed-block')
  }, {
    src: '/assets/js/components/language-switcher.min.js' + verEnding,
    el: document.querySelector('.js-wpml-ls-item-toggle'),
    loadImmediatelyIfVisible: false
  }];
...
/***/ 0:
/*!***********************************************************!*\
  !*** multi ./src/js/frontend.js ./src/scss/frontend.scss ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! /Users/pawkat/Documents/Repositories/ajax-systems/wp-content/themes/ajax-systems/src/scss/frontend.scss */"./src/scss/frontend.scss");
