...
!function ($) {
  Object(_modules_controller__WEBPACK_IMPORTED_MODULE_1__["default"])();
  $(document).on('ready', _hooks_onReady__WEBPACK_IMPORTED_MODULE_0__["default"].bind(this));
}(jQuery);
...
/* harmony import */ var _utilities_aload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utilities/aload */ "./src/js/utilities/aload.js");
/* harmony import */ var _utilities_firstInteraction__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utilities/firstInteraction */ "./src/js/utilities/firstInteraction.js");



function onReady() {
  var $ = jQuery;
  Object(_utilities_aload__WEBPACK_IMPORTED_MODULE_1__["aload"])();
  $(document).on('firstInteraction', function () {
    Object(_utilities_aload__WEBPACK_IMPORTED_MODULE_1__["aload"])(null, true);
  });
  Object(_utilities_firstInteraction__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_utilities_loadScripts__WEBPACK_IMPORTED_MODULE_0__["default"])();
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utilities_$fn__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utilities/$fn */ "./src/js/utilities/$fn.js");

var $ = jQuery;
/* harmony default export */ __webpack_exports__["default"] = (function () {
  $.fn.controller = new _utilities_$fn__WEBPACK_IMPORTED_MODULE_0__["default"]('controller', {
    init: function init() {
      var $this = $(this);
    ...
    loadScripts: function loadScripts() {
      ...
      var $this = name ? $(this).find("[data-script=\"".concat(name, "\"")) : $(this).find('[data-src]');
      /**
       * Load the scripts
       */
      ...
      return function (method) {
        try {
          if (methods[method]) {
            ...
            console.warn('Method named ' + method + " isn't exist within jQuery.".concat(name));
            return $(this);
          }
        } catch (e) {
          var location = method ? "jQuery.fn.".concat(name, "('").concat(method, "')") : "jQuery.fn.".concat(name, "()");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ "./src/js/utilities/helpers.js");
...
var theme_path = window.ajax_systems.theme_path;
var initiated = [];
var loaded = [];
...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function defer() {
      ...
      var isVisible = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getScrolledBottomCorner"])() >= Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getOffset"])(this.el);
...
function aload(nodes) {
  ...
  [].forEach.call(nodes, function (node) {
    if (node.tagName === 'IMG' || node.tagName === 'IFRAME' || node.classList.contains('aload-bg')) {
      var offset = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getOffset"])(node);

      if (offset && Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["getScrolledBottomCorner"])() >= offset && !node.dataset.dontLoadImmediately || loadAlways) {
...
/*!*************************************!*\
  !*** ./src/js/utilities/helpers.js ***!
  \*************************************/
/*! exports provided: getScrolledBottomCorner, getScrollTop, getElScrollTop, getOffset, debounce, getBottomBorder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getElScrollTop", function() { return getElScrollTop; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOffset", function() { return getOffset; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "debounce", function() { return debounce; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBottomBorder", function() { return getBottomBorder; });
var $ = jQuery;
function getScrolledBottomCorner() {
  return getScrollTop() + window.innerHeight; // return (window.pageYOffset || document.documentElement.scrollTop) + window.innerHeight;
}
...
function getBottomBorder(element) {
...
var theme_version = window.ajax_systems.theme_version;
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var scriptsToLoad = [];

  if (typeof window.scripts_to_enqueue !== 'undefined' && window.scripts_to_enqueue) {
    var _window = window,
        scripts_to_enqueue = _window.scripts_to_enqueue;
...
/***/ "./src/scss/components/logos.scss":
/*!****************************************!*\
  !*** ./src/scss/components/logos.scss ***!
  \****************************************/
/*! no static exports found */
...
/***/ 0:
/*!**********************************************************************************************************************************************************************************************!*\
  !*** multi ./src/js/frontend.js ./src/scss/frontend.scss ./src/scss/components/hero.scss ./src/scss/components/logos.scss ./src/scss/components/form.scss ./src/scss/components/slider.scss ***!
  \**********************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/pawkat/Documents/Repositories/ajax-systems/wp-content/themes/ajax-systems/src/js/frontend.js */"./src/js/frontend.js");
__webpack_require__(/*! /Users/pawkat/Documents/Repositories/ajax-systems/wp-content/themes/ajax-systems/src/scss/frontend.scss */"./src/scss/frontend.scss");
__webpack_require__(/*! /Users/pawkat/Documents/Repositories/ajax-systems/wp-content/themes/ajax-systems/src/scss/components/hero.scss */"./src/scss/components/hero.scss");
__webpack_require__(/*! /Users/pawkat/Documents/Repositories/ajax-systems/wp-content/themes/ajax-systems/src/scss/components/logos.scss */"./src/scss/components/logos.scss");
__webpack_require__(/*! /Users/pawkat/Documents/Repositories/ajax-systems/wp-content/themes/ajax-systems/src/scss/components/form.scss */"./src/scss/components/form.scss");
module.exports = __webpack_require__(/*! /Users/pawkat/Documents/Repositories/ajax-systems/wp-content/themes/ajax-systems/src/scss/components/slider.scss */"./src/scss/components/slider.scss");
